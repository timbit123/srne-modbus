...
mqtt_set_config: dict[str, any] = {
    ...
    "charging/grid_charging_current_limit": modbus.write_grid_charging_current_limit,
    ...
    "charging/time_charge_1_soc_limit": modbus.write_stop_time_charge_soc_1,
    "charging/time_charge_2_soc_limit": modbus.write_stop_time_charge_soc_2,
    "charging/time_charge_3_soc_limit": modbus.write_stop_time_charge_soc_3,
    "charging/time_charge_1_max_power": modbus.write_time_charge_max_power_1,
    "charging/time_charge_2_max_power": modbus.write_time_charge_max_power_2,
    "charging/time_charge_3_max_power": modbus.write_time_charge_max_power_3,
    "charging/time_discharge_enabled": modbus.write_time_discharge_enabled,
    "charging/time_discharge_1_soc_limit": modbus.write_stop_time_discharge_soc_1,
    "charging/time_discharge_2_soc_limit": modbus.write_stop_time_discharge_soc_2,
    "charging/time_discharge_3_soc_limit": modbus.write_stop_time_discharge_soc_3,
    "charging/time_discharge_1_max_power": modbus.write_time_discharge_max_power_1,
    "charging/time_discharge_2_max_power": modbus.write_time_discharge_max_power_2,
    "charging/time_discharge_3_max_power": modbus.write_time_discharge_max_power_3,
    ...
    "inverter/generator_mode": modbus.write_gen_mode,
...
mqtt_config: dict[str, dict[str, any]] = {
    ...
    "charging/grid_charging_current_limit": {
        "enabled": battery_enabled,
        "value": modbus.read_grid_charging_current_limit,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
            ...
            "max": 200,
            "step": 1,
            "command_topic": "charging/grid_charging_current_limit",
            "mode:": "box",
        },
    },
    ...
    "inverter/hybrid_mode": {
        ...
        "config": {
            ...
            "icon": "mdi:export",
            "options": ["On Grid", "Limit Power to UPS", "Limit Power to Home", "AC Coupling"],
    ...
    "inverter/generator_mode": {
        ...
        "config": {
            ...
            "icon": "mdi:export",
            "options": ["Generator Mode", "Micro Inverter Mode", "Smart Load Mode"],
    ...
    "charging/time_discharge_enabled": {
        "value": modbus.read_time_discharge_enabled,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "select",
        "config": {
    ...
    "charging/time_charge_1_start": {
        "enabled": True,
        "value": modbus.read_charge_start_time_1,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_2_start": {
        "enabled": True,
        "value": modbus.read_charge_start_time_2,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_3_start": {
        "enabled": True,
        "value": modbus.read_charge_start_time_3,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_1_start": {
        "enabled": True,
        "value": modbus.read_discharge_start_time_1,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_2_start": {
        "enabled": True,
        "value": modbus.read_discharge_start_time_2,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_3_start": {
        "enabled": True,
        "value": modbus.read_discharge_start_time_3,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_1_end": {
        "enabled": True,
        "value": modbus.read_charge_end_time_1,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_2_end": {
        "enabled": True,
        "value": modbus.read_charge_end_time_2,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_3_end": {
        "enabled": True,
        "value": modbus.read_charge_end_time_3,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_1_end": {
        "enabled": True,
        "value": modbus.read_discharge_end_time_1,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_2_end": {
        "enabled": True,
        "value": modbus.read_discharge_end_time_2,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_discharge_3_end": {
        "enabled": True,
        "value": modbus.read_discharge_end_time_3,
        "interval": general_interval,
        "last_update": None,
        "config": {
    ...
    "charging/time_charge_1_soc_limit": {
        "enabled": battery_enabled,
        "value": modbus.read_stop_time_charge_soc_1,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_discharge_1_soc_limit": {
        "enabled": battery_enabled,
        "value": modbus.read_stop_time_discharge_soc_1,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_charge_1_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_charge_max_power_1,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_charge_2_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_charge_max_power_2,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_charge_3_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_charge_max_power_3,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_discharge_1_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_discharge_max_power_1,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_discharge_2_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_discharge_max_power_2,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
    ...
    "charging/time_discharge_3_max_power": {
        "enabled": battery_enabled,
        "value": modbus.read_time_discharge_max_power_3,
        "interval": general_interval,
        "last_update": None,
        "topic_type": "number",
        "config": {
